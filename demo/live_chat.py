...
turn. It asserts role routing, read-only reach for catalog, that the cart role
never sees order tools, and that no reply ever echoes a confirmation code.
It never confirms or places an order.
